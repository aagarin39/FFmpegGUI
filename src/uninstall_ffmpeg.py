"""
Утилита удаления FFmpeg
Запускается с флагом --uninstall-ffmpeg или отдельно
"""
import sys
import shutil
...
class UninstallDialog(QDialog):
    ...
    def __init__(self):
        ...
        self.shortcut_path = Path.home() / "Desktop" / "Удалить FFmpeg.lnk"
    ...
    def _init_ui(self):
        ...
        """)
        delete_btn.clicked.connect(self._start_uninstall)
